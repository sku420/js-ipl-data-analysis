...
def teams_by_season_main
  ...
  team_match_data['season'] = matches_by_team_by_season.keys

  # processing hash to get labels and match played by teams in each year
  matches_by_team_by_season.each_with_index do |(_, value), label_index|
  ...
  # hash => json
  create_json(team_match_data, 'matches_by_teams_seasons')
end
